...
export default function Map3rd(props) {
  ...
  const onPressSpace = number => {
    ...
    return(
        ...
        <View style={styles.mapRow}>
        {/* 3行目 */}
          <Text onPress={() => {onPressSpace('05')}} style={((props.parkingFloor === '2') && (props.parkingSpace === '05') || (props.selectingSpace === '05')) ? styles.spaceSelected : styles.space}>27</Text>
          <Text style={styles.spaceHidden}></Text>
          <Text style={styles.spaceHidden}></Text>
          ...
          <Text onPress={() => {onPressSpace('08')}} style={((props.parkingFloor === '2') && (props.parkingSpace === '08') || (props.selectingSpace === '08')) ? styles.spaceSelected : styles.space}>08</Text>
          <Text style={styles.spaceHidden}></Text>
          <Text style={styles.spaceHidden}></Text>
        </View>
        <View style={styles.mapRow}>
        {/* 4行目 */}
          ...
          <Text style={styles.spaceHidden}></Text>
          <Text onPress={() => {onPressSpace('07')}} style={((props.parkingFloor === '2') && (props.parkingSpace === '07') || (props.selectingSpace === '07')) ? styles.spaceSelected : styles.space}>07</Text>
          <Text style={styles.spaceHidden}></Text>
          <Text style={styles.spaceHidden}></Text>
        </View>
        <View style={styles.mapRow}>
          ...
          <Text style={styles.spaceHidden}></Text>
          <Text onPress={() => {onPressSpace('06')}} style={((props.parkingFloor === '2') && (props.parkingSpace === '06') || (props.selectingSpace === '06')) ? styles.spaceSelected : styles.space}>06</Text>
          <Text style={styles.spaceHidden}></Text>
          <Text onPress={() => {onPressSpace('00')}} style={((props.parkingFloor === '2') && (props.parkingSpace === '00') || (props.selectingSpace === '00')) ? styles.spaceSelected : styles.space}>00</Text>
        </View>
        <View style={styles.mapRow}>
          {/* 6行目 */}
          ...
          <Text style={styles.spaceHidden}></Text>
          <Text onPress={() => {onPressSpace('05')}} style={((props.parkingFloor === '2') && (props.parkingSpace === '05') || (props.selectingSpace === '05')) ? styles.spaceSelected : styles.space}>05</Text>
          <Text style={styles.spaceHidden}></Text>
          <Text onPress={() => {onPressSpace('00')}} style={((props.parkingFloor === '2') && (props.parkingSpace === '00') || (props.selectingSpace === '00')) ? styles.spaceSelected : styles.space}>00</Text>
        </View>
        <View style={styles.mapRow}>
          ...
          <Text style={styles.spaceHidden}></Text>
          <Text onPress={() => {onPressSpace('04')}} style={((props.parkingFloor === '2') && (props.parkingSpace === '04') || (props.selectingSpace === '04')) ? styles.spaceSelected : styles.space}>04</Text>
          <Text style={styles.spaceHidden}></Text>
          <Text style={styles.spaceHidden}></Text>
        </View>
        <View style={styles.mapRow}>
